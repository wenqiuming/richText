...
(function ($) {
    ...
    $.fn.emojiPicker = function (options) {
        ...
        var iconsName = ['爱你', '奥特曼', '拜拜', '抱抱', '悲伤', '并不简单', '鄙视', '闭嘴', '馋嘴', '吃惊', '打哈欠', '打脸', '顶', 'doge', '二哈', '费解', '肥皂', '感冒', '鼓掌', '哈哈', '害羞', '汗', '呵呵', '嘿嘿嘿', '黑线', '哼', '坏笑', '花心', '挤眼', '可爱', '可怜', '酷', '骷髅', '困', '懒得理你', '泪', '马到成功', '喵', '男孩儿', '怒', '怒骂', '女孩儿', '钱', '亲亲', '傻眼', '生病', '神兽', '失望', '衰', '睡觉', '思考', '太开心', '摊手', '舔屏', '偷笑', '吐', '兔子', '挖鼻屎', '委屈', '污', '笑哭', '憧憬', '熊猫', '嘻嘻', '虚', '阴险', '疑问', '右哼哼', '晕', '捂脸', '抓狂', '猪头', '最右'];
